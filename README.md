...
<H2> Büyük Veri (Big Data) Çalışmaları </H2>
<H3> Örnek-1 </H3>
...
Daha sonra bu sitedeki <a href="https://community.cloud.databricks.com/login.html"> Sanal Sistemde</a> önce veriler upload edilmiştir. Daha sonra Jupyter benzeri bir notebook ile çalışılmıştır. 
Örnek kod <a href="https://github.com/VedatBiner/BTK-VeriMaratonu/blob/master/verimaratonu-spark-1.ipynb">buradadır</a>.